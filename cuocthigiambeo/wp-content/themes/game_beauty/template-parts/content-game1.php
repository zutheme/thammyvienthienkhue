    ...
    <form class="frm-register">
               ...
               <!--  <h3>Số đo cơ thể</h3>
                ...
                <div>
                    ...
                    <div class="w50">
                        ...
                        <p><span>Bụng</span><input type="text" class="txtbung" id="txtbung" placeholder="..............."></p>

                    </div>

                    <div class="w50">

                        <p><span>Bắp tay</span><input type="text" class="txtbaptay" id="txtbaptay" placeholder="..............."></p>

                    </div>

                    <div class="w50">

                        <p><span>Eo</span><input type="text" class="txteo" id="txteo" placeholder="..............."></p>

                    </div>

                    <div class="w50">

                        <p><span>Đùi</span><input type="text" class="txtdui" id="txtdui" placeholder="..............."></p>
        ...
        <div class="content-right">
            ...
            <div class="i5">
                ...
                <p>Hãy gửi kèm 03 hình ảnh cá nhân mới nhất của bạn (1 ảnh cận đứng, 1 ảnh cận ngồi và 1 ảnh cận vùng cơ thể bạn muốn giảm nhất) cho chúng tôi kèm theo bản đăng ký tham gia này</p>

                <div class="w3">

                    <p><a href="javascript:void(0)" onclick="performClick('file1');"><i class="fa fa-camera-retro" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Ảnh cận đứng</a>
                ...
                <div class="w3">
                    ...
                    <p><a href="javascript:void(0)" onclick="performClick('file2');"><i class="fa fa-camera-retro" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Ảnh cận ngồi</a>
                ...
                <div class="w3">
                    ...
                    <p><a href="javascript:void(0)" onclick="performClick('file3');"><i class="fa fa-camera-retro" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Ảnh cận vùng cơ</a>
