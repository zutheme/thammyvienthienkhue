...
var _e_image_button = document.getElementsByClassName('upload-images-button');
...
function upload_image(){
    ...
    meta_image_frame.on('select', function(){
        ...
        var _images_field = _e_parent.getElementsByClassName("images_field")[0];
        var _img_set = _e_parent.getElementsByClassName("img_set")[0];
        _img_set.src = media_attachment.url;
        _images_field.value = media_attachment.url;
    });
