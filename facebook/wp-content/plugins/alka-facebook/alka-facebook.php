...
class AlkaFacebook{
     ...
     * @var string
     */
    private $app_id = '168231173842748';
     ...
     * @var string
     */
    private $app_secret = '4ade0f4ee30d99e4d06aac52ad54a4b5';
     ...
     * @var string
     */
    private $callback_url = 'https://thammyvienthienkhue.vn/facebook/wp-admin/admin-ajax.php?action=alka_facebook';
    ...
    public function renderShortcode() {
        ...
        //$html .= '<a href="#" class="btn" id="alka-facebook-button">'.$button_label.'</a>';     
        //$fb = $this->initApi();
