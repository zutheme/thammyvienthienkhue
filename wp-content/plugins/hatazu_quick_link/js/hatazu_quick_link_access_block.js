          ...
          if(len > 2) {
            ...
            //lb_discount = discount+"k";
             if(downlink =='dlp199'){
                 ...
                 _nextlink ="https://thammyvienthienkhue.vn/tet-vui-tha-ga-cung-biolight-tri-mun-chi-199k/";
...
var e_modal_fix_floor2 = document.getElementsByClassName('modal-form-popup-fix-floor2')[0]
var modal_fix_floor2 = e_modal_fix_floor2.getElementsByClassName('modal')[0];
var btnclose_fix_floor2 = e_modal_fix_floor2.getElementsByClassName("close")[0];
function popup_langding(){
  ...
  if((service=='k0')||(service=='d0')){
    ...
    modal_floor2.getElementsByClassName('orther-link')[0].setAttribute('href',_nextlink);
    modal_floor2.style.display = "block";
  }else if(downlink='dlp199'){
    modal_fix_floor2.style.display = "block";
  }
}
...
btnclose_floor2.onclick = function() {
  modal_fix_floor2.style.display = "none";
  if(downlink=='d199'){
    modal_floor3.style.display = "block";
  }
}
btnclose_fix_floor2.onclick = function() {
  modal_fix_floor2.style.display = "none";
}
...
function reg_survey(){
  ...
  _address = "tagdiv:"+service+", tt:"+_check_method;
  _job = _url;
  var http = new XMLHttpRequest();
  //var url = "https://thammyvienthienkhue.com.vn/api/svcustomers";
  var url = "https://api.caresoft.vn/tmvthienkhue/api/v1/tickets";
  //var obj = JSON.stringify({name:"John Rambo", email:_email});
  var params = JSON.stringify({
	"ticket": {
	"ticket_subject": "dang ky",
	"ticket_comment": name_sevice+", phương thức: "+_check_method+", url: "+_url,
	"email": _email,
	"username": _fullname,
	"phone": _phone,
  ...
  http.setRequestHeader("Authorization", "Bearer M6eRDZ2EBAguEkw");
           ...
           Object.keys(myArr).forEach(function(key) {   
            if(myArr.code=='ok'){
               _e_frm_reg.getElementsByClassName('fullname')[0].value = "";
                ...
                _e_frm_reg.getElementsByClassName("result")[0].innerHTML = "Cảm ơn bạn "+_fullname+" đã tham gia<br>"+str_method;
                setTimeout(function(){
