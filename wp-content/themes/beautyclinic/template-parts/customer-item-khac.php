...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12 text-left"><h3 class="title-main">Dịch vụ khác</h3></div>
		<div class="col-xs-12 col-md-12 col-centered">



			<div id="carousel5" class="carousel slide" data-ride="carousel" data-type="multi" data-interval="2500">
				...
				<div class="left carousel-control">
					...
					<a href="#carousel5" role="button" data-slide="prev">
				...
				<div class="right carousel-control">
					...
					<a href="#carousel5" role="button" data-slide="next">
