...
<div class="container">
	...
	<div class="row">
		<div class="col-md-12 text-left"><h3 class="title-main">Trị nám</h3></div>
		<div class="col-xs-12 col-md-12 col-centered">



			<div id="carousel4" class="carousel slide" data-ride="carousel" data-type="multi" data-interval="2500">
