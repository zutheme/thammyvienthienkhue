	           		 ...
	           		 <div class="item">
		                    ...
		                    <div class="snip-vi">
		                        ...
		                        <div class="video">
		                            ...
		                            <a href="#tm-post-popup1-<?php echo $id; ?>" class="open-galleryimg-link"><i class="fa fa-search-plus"></i></a>

		                        </div>

		                    </div>

		                    <div id="tm-post-popup1-<?php echo $id; ?>" class="post-popup popup-modal">
