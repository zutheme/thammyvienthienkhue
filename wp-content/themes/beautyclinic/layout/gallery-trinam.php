	           		 ...
	           		 <div class="item">
		                    ...
		                    <div class="snip-vi">
		                        ...
		                        <div class="video">
		                            ...
		                            <a href="#tn-post-popup1-<?php echo $id; ?>" class="open-galleryimg-link"><i class="fa fa-search-plus"></i></a>

		                        </div>

		                    </div>

		                    <div id="tn-post-popup1-<?php echo $id; ?>" class="post-popup popup-modal">
