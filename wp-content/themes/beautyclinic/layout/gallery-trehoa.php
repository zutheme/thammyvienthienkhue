          ...
          while ($team_query->have_posts()) {
				...
				if($count==0){ $active="active"; }else { $active="";} 
	           	...
	           	?>
	           		 ...
	           		 <div class="item"><i class="icon-zoom-in"></i>
		                    ...
		                    <div class="snip-vi">
		                        ...
		                        <div class="video">
		                            ...
		                            <a href="#th-post-popup1-<?php echo $id; ?>" class="open-galleryimg-link"><i class="fa fa-search-plus"></i></a>

		                        </div>

		                    </div>

		                    <div id="th-post-popup1-<?php echo $id; ?>" class="post-popup popup-modal">
