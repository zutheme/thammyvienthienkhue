...
function porto_css() {
    ...
    if (is_rtl()) {
        ...
        if (file_exists($css_file)) {
            ...
            //wp_register_style( 'porto-theme', porto_uri.'/css/theme.css?ver=4.9.5');
        }

    }
     //wp_register_style( 'porto-theme', get_stylesheet_directory_uri() . '/style.css',array(), '4.9.8', 'all');
    ...
    wp_register_style( 'porto-style', porto_uri . '/style.css?ver=4.9.8');
...
function tmv_custom_style() 
 {
    //css
    //wp_enqueue_style( 'tmv-bootstrap.min.css',"https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css",array(), '3.3.7', 'all');
    wp_enqueue_style( 'tmv-bootstrap.min.css', get_template_directory_uri() . "/font-awesome-4.7.0/css/font-awesome.min.css",array(), '4.7.0', 'all');
    //jquery
    //wp_enqueue_script( 'tmv-jquery.min.js','https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js', array(), '1.0.0', true );
    //wp_enqueue_script( 'tmv-bootstrap.min.js','https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js', array(), '1.0.0', true );  
    wp_enqueue_script( 'tmv-custom.js', get_template_directory_uri() . '/js/tmv-custom.js', array(), '1.0.1', true );   
    wp_localize_script( 'tmv-custom.js', 'MyAjax', array('ajaxurl' => admin_url( 'admin-ajax.php' ),'security' => wp_create_nonce( 'my-special-string' )));   
 }
add_action("wp_enqueue_scripts", "tmv_custom_style");
