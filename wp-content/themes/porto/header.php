...
<head>
    ...
    <title><?php bloginfo('name'); ?> <?php if ( is_archive()) { bloginfo('description'); } else if( is_single() ) { ?> &raquo; <?php } ?> <?php wp_title(); ?> - <?php bloginfo('description'); ?> </title>
    <link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>" />
   <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/custom.css?ver=5.7.8">
   <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/theme.css?ver=4.9.9">
   <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/navbar.css?ver=1.0.0">
    <link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/css/responsive-sm.css?ver=1.0.0">
...
<body <?php body_class(array($body_class)); ?><?php echo $showing_overlay ? 'data-loading-overlay' : '' ?>>
    ...
    ?>
     <?php get_template_part('header/header_15');
        if ( $page_home ) {
